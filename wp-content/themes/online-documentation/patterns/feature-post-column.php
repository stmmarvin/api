 ...
 * Slug: online-documentation/feature-post-column
 * Categories: template
 */
?>
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'online-documentation' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'online-documentation' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
